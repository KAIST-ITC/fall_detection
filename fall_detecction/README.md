`make data_wranggle` to cut or pad radar data in ./data so that the number of frames is all 25. This command will generate new data and store them in ./data_ready
